...
\caption{Cost defined as execution time per grid DOF and time step on the different cases and grid levels. Data related resulting from figure \ref{fig:benchmarks} benchmarks.}
\label{fig:cost}
\end{figure}
