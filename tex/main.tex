...
\author[a,b]{Bernat Font\corref{author}}
...
\address[b]{Barcelona Supercomputing Center, Barcelona, Spain}
...
\begin{tabular}{llll}
    ...
    \hline
    CANS \cite{Costa2018} & Incompressible canonical flows on rectilinear grids & FDM & Fortran/OpenACC \\
    ...
    PyFR \cite{Witherden2015} & \makecell{Compressible/incompressible flows on\\ unstructured grids} & FR & \makecell{Python + C/OpenMP, \\ CUDA, OpenCL} \\
    RHEA \cite{Jofre2023} & Compressible flows on rectilinear grids & FDM & C++/OpenACC \\
    SOD2D \cite{Gasparino2024} & \makecell{Compressible/incompressible flows on\\ unstructured grids} & SEM & Fortran/OpenACC \\
    STREAmS \cite{Bernardini2021} & \makecell{Compressible canonical wall-bounded flows\\ on rectilinear grids} & FDM & CUDA-Fortran \\
    \hline
\end{tabular}
