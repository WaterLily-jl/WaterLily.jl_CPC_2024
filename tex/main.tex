...
\begin{figure}
    \centering
    \includegraphics[width=0.24\linewidth,trim={90 150 70 200},clip]{jl/examples/Jelly_1.png}
    \includegraphics[width=0.24\linewidth,trim={90 150 70 200},clip]{jl/examples/Jelly_2.png}
    \includegraphics[width=0.24\linewidth,trim={90 150 70 200},clip]{jl/examples/Jelly_3.png}
    % \includegraphics[width=0.16\linewidth,trim={90 150 70 200},clip]{jl/examples/Jelly_4.png}
    \includegraphics[width=0.24\linewidth,trim={90 150 70 200},clip]{jl/examples/Jelly_5.png}
    % \includegraphics[width=0.16\linewidth,trim={90 150 70 200},clip]{jl/examples/Jelly_6.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.32\linewidth,trim={90 150 70 200},clip]{jl/examples/Butterfly_1.png}
    \includegraphics[width=0.32\linewidth,trim={90 150 70 200},clip]{jl/examples/Butterfly_2.png}
    \includegraphics[width=0.32\linewidth,trim={90 150 70 200},clip]{jl/examples/Butterfly_3.png}
    \includegraphics[width=0.32\linewidth,trim={90 150 70 200},clip]{jl/examples/Butterfly_4.png}
    \includegraphics[width=0.32\linewidth,trim={90 150 70 200},clip]{jl/examples/Butterfly_5.png}
