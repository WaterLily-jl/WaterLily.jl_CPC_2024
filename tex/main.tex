...
\begin{figure}[!t]
    \begin{subfigure}{0.48\linewidth}
      \center
        \includegraphics[width=\linewidth,trim={50 30 20 30},clip]{img/OscCyl_flow.pdf}
        \caption{Cylinder path and spanwise-averaged vorticity field}
    \end{subfigure}
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{img/OscCyl_hist.pdf}
