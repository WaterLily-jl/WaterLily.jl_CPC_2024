...
point (FP32). In terms of FP32 peak perfromance, the NVIDIA GPU offers 60 TFLOPs (ie. $60\cdot10^{12}$ floating-point operations per second) and the AMD GPU offers 50TFLOPs, approximately. Both GPUs have 64GB of vRAM.}
