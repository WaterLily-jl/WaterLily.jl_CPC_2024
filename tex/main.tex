...
\begin{tabular}{llll}
    ...
    \makecell{\revC{MFC}\\ \cite{Bryngelson2021}} & \makecell{Compressible multi-phase flows\\ on structured grids} & FVM & Fortran+Fypp/OpenACC \\\hline
